...
## Exact Code Diffs for Step 1 + Step 2 (Ready to Apply)

### Diff for Step 1: `PresetTransition.cpp`
...
### Diff for Step 2: Shared Transition Shader Header
...
**How to use:**
- Copy the diffs above into kimi-cli and say:  
  > "Apply these exact diffs for Step 1 and Step 2, then continue with Step 3."

---

Let me know when kimi-cli finishes Step 1+2 and I’ll give you the next focused task (shader audit).
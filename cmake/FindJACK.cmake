...
if(JACK_FOUND AND NOT TARGET JACK::JACK)
    add_library(JACK_INTERFACE_LIBRRARY INTERFACE)

    set_target_properties(JACK_INTERFACE_LIBRRARY PROPERTIES
    ...
    add_library(JACK::JACK ALIAS JACK_INTERFACE_LIBRRARY)
endif()

 ...
 * Date: 20090823
 * File: VisualAnimationSequence.h
 *
 */
...
#ifndef VisualAnimationSequence_h
#define VisualAnimationSequence_h
...
namespace VizKit {
	...
	/**
	 * A VisualAnimationSequence is a collection of animations where the animations run sequentially. Animations are added by calling add().
	 */
	class VisualAnimationSequence : public VisualAnimationComponent {
	...
	public:
		...
		/**
		 * Copy constructor.
		 * @param other Reference to another VisualAnimationSequence.
		 */
		 ...
		 * @param other Reference to another VisualAnimationSequence.
		 */
		VisualAnimationSequence& operator=(const VisualAnimationSequence& other);
	...
	private:
		 ...
		 * @param other Another VisualAnimationSequence.
		 */
		...
		/** The optional identifier of the parent collection of the sequence (the cluster resp. sequence the current sequence is part of). */
...
#endif /* VisualAnimationSequence_h */

...
OpenGLCopyTexture::OpenGLCopyTexture()
{
    Init();
...
void OpenGLCopyTexture::InitVertexAttrib()
{
...
void OpenGLCopyTexture::Draw(const std::shared_ptr<class Texture>& originalTexture, bool flipVertical, bool flipHorizontal)
{
...
void OpenGLCopyTexture::Draw(const std::shared_ptr<class Texture>& originalTexture, const std::shared_ptr<class Texture>& targetTexture,
...
void OpenGLCopyTexture::Draw(const std::shared_ptr<class Texture>& originalTexture, Framebuffer& framebuffer, int framebufferIndex,
                       bool flipVertical, bool flipHorizontal)
{
    if (originalTexture == nullptr
        || originalTexture->Empty()
...
auto OpenGLCopyTexture::Texture() -> std::shared_ptr<class Texture>
{
    return m_framebuffer.GetColorAttachmentTexture(0, 0);
}

void OpenGLCopyTexture::UpdateTextureSize(int width, int height)
{
    if (m_width == width &&
        m_height == height)
    {
...
void OpenGLCopyTexture::Copy(bool flipVertical, bool flipHorizontal) const
{
    m_shader.Bind();

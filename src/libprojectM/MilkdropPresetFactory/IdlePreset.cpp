...
IdlePresets::allocate(MilkdropPresetFactory* factory, PresetOutputs* presetOutputs)
{
    std::istringstream in(presetText());
    return std::unique_ptr<Preset>(new MilkdropPreset(factory, in, presetOutputs));
}

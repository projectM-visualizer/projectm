...
#define GST_PROJECTMVIZ(obj)   (G_TYPE_CHECK_INSTANCE_CAST((obj),GST_TYPE_PROJECTMVIZ,GstProjectmviz))
#define GST_PROJECTMVIZ_CLASS(klass)   (G_TYPE_CHECK_CLASS_CAST((klass),GST_TYPE_PROJECTMVIZ,GstProjectmvizClass))
#define GST_IS_PROJECTMVIZ(obj)   (G_TYPE_CHECK_INSTANCE_TYPE((obj),GST_TYPE_PROJECTMVIZ))
#define GST_IS_PROJECTMVIZ_CLASS(obj)   (G_TYPE_CHECK_CLASS_TYPE((klass),GST_TYPE_PROJECTMVIZ))

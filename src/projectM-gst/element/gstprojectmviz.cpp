...
static void gst_projectmviz_set_property (GObject * object,
    guint property_id, const GValue * value, GParamSpec * pspec);
static void gst_projectmviz_get_property (GObject * object,
...
G_DEFINE_TYPE_WITH_CODE (GstProjectmviz, gst_projectmviz, GST_TYPE_AUDIO_SINK,
    GST_DEBUG_CATEGORY_INIT (gst_projectmviz_debug_category, "projectmviz", 0,
        "debug category for projectmviz element"));

static void
gst_projectmviz_class_init (GstProjectmvizClass * klass)
{
  ...
  gst_element_class_set_static_metadata (GST_ELEMENT_CLASS (klass),
      "ProjectM Visualizer", "Generic", "Visualizes audio input",
      "<mischa@mvstg.biz>");
...
static void
gst_projectmviz_init (GstProjectmviz * projectmviz)
{
}

void
gst_projectmviz_set_property (GObject * object, guint property_id,
...
void
gst_projectmviz_get_property (GObject * object, guint property_id,
...
void
gst_projectmviz_dispose (GObject * object)
{
  GstProjectmviz *projectmviz = GST_PROJECTMVIZ (object);
...
void
gst_projectmviz_finalize (GObject * object)
{
  GstProjectmviz *projectmviz = GST_PROJECTMVIZ (object);
...
static gboolean
gst_projectmviz_open (GstAudioSink * sink)
{
...
static gboolean
gst_projectmviz_prepare (GstAudioSink * sink, GstAudioRingBufferSpec * spec)
{
  GstProjectmviz *projectmviz = GST_PROJECTMVIZ (sink);
...
static gboolean
gst_projectmviz_unprepare (GstAudioSink * sink)
{
  GstProjectmviz *projectmviz = GST_PROJECTMVIZ (sink);
...
/* close the device */
static gboolean
gst_projectmviz_close (GstAudioSink * sink)
{
  GstProjectmviz *projectmviz = GST_PROJECTMVIZ (sink);
...
static gint
gst_projectmviz_write (GstAudioSink * sink, gpointer data, guint length)
{
  GstProjectmviz *projectmviz = GST_PROJECTMVIZ (sink);

  GST_DEBUG_OBJECT (projectmviz, "write");

  g_print("writing %u samples\n");
...
static guint
gst_projectmviz_delay (GstAudioSink * sink)
{
  GstProjectmviz *projectmviz = GST_PROJECTMVIZ (sink);
...
static void
gst_projectmviz_reset (GstAudioSink * sink)
{
  GstProjectmviz *projectmviz = GST_PROJECTMVIZ (sink);
